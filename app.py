...
@st.cache_resource
def initialize_llm():
    return OllamaLLM(model=os.getenv("OLLAMA_MODEL"),temperature=0.1)
...
def create_enhanced_rag_prompt():
    return ChatPromptTemplate.from_template("""
        You are an expert AI assistant tasked with providing comprehensive answers using **only** the context provided irrespective of what kind of data it is.
        ...
        **Your Response**:
        ...
        2. **Supporting Details**: Expand the answer with details and evidence drawn from the context and elaborate and give lengthy content.
        3. **Sources**: Mention the sources of the document
    """)
